  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        items:
          'Slide 1 title | Slide 1 image\nSlide 2 title | Slide 2 image\nSlide 3 title | Slide 3 image',
      },
      {
        id: 'home-pillars',
          ...
          <section class="editor" aria-label="Page editor">
            <header class="editor-header">
              ...
              <div class="editor-actions">
                ...
                <!-- Slideshow scroll button (stays on page) -->
                <button
                  v-if="activePage.slug === 'home'"
                  class="button button-secondary"
                  type="button"
                  @click="scrollToHomeSlideshowSection"
                >
            ...
            <div class="editor-workflow">
              <div class="editor-form-column">
                ...
                <section class="sections-editor form-panel" aria-label="Page sections">
                  ...
                  >
                    <details
                      :open="route.path === '/admin/editor/home' ? section.id === 'home-slideshow' : true"
                    >
                      ...
                      <template v-if="section.id === 'home-slideshow'">
                        <div class="slideshow-editor">
                          ...
                          <div v-if="homeSlides.length === 0" class="slideshow-empty">
                            Upload an image to create your first slide.
                          </div>

                          <div v-for="(slide, i) in homeSlides" :key="slide.__key" class="slide-card">
                            <div class="slide-card-top">
                              ...
                              <div class="slide-card-actions">
                                ...
                                <button
                                  type="button"
                                  class="icon-button"
                                  :disabled="i === homeSlides.length - 1"
                            ...
                            <div class="slide-grid">
                              ...
                              <div class="slide-image">
                                <div class="slide-preview" :class="{ 'is-empty': !slide.image }">
                                  <img
                                    v-if="slide.image"
                                    :src="slide.image"
                                ...
                                <label class="upload-wrap">
                                  <input
                                    type="file"
                                    accept="image/*"
                                    @change="(e) => onHomeSlideImageUpload(e, i)"
                                  />
                                  <span class="upload-copy">Upload / replace image</span>
                                </label>
                              </div>
                              ...
                              <div class="slide-fields">
                                <div class="slide-field-row">
                                  <label>
                                    ...
                                    <input v-model="slide.eyebrow" placeholder="e.g. 'Featured'" />
                                  </label>
                                  <label>
                                    <span>Title</span>
                                ...
                                <div class="slide-field-row">
                                  <label>
                                    ...
                                    <input v-model="slide.primaryLabel" placeholder="Button text" />
                                  </label>
                                  <label>
                                    <span>Primary link</span>
                                    <input v-model="slide.primaryTo" placeholder="/path or URL" />
                                  </label>
                                </div>
                                <div class="slide-field-row">
                                  <label>
                                    <span>Secondary label</span>
                                    <input v-model="slide.secondaryLabel" placeholder="Button text" />
                                  </label>
                                  <label>
                                    <span>Secondary link</span>
                                    <input v-model="slide.secondaryTo" placeholder="/path or URL" />
                                  </label>
                                </div>
                                <div class="slide-field-row">
                                  <label>
                                    <span>Position (text alignment)</span>
...
<style scoped>
/* ---------- Your original styles (all of them) – keep exactly as you had ---------- */
.editor-page {
