...
const buddhistEducationImage = imageUrls.volunteer.buddhistEducation
const childProtectionImage = imageUrls.volunteer.childProtection
const communityForestryImage = imageUrls.volunteer.communityForestry
const livelihoodImage = imageUrls.volunteer.livelihood
const mobileLibraryImage = imageUrls.volunteer.mobileLibrary
const volunteerHeroImage = imageUrls.volunteer.hero
const washSchoolImage = imageUrls.volunteer.washSchool
