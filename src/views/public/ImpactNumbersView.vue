...
onMounted(() => {
  ...
  setMeta(
    'description',
    "Villages, hectares, students, savings groups and biogas units — the measurable footprint of Santi Sena's 30 years in Cambodia.",
  )
    ...
    <section class="operation-section">
      <div class="container">
        <div class="section-header">
          ...
          <p>
            Since 1994, our programs have maintained a continuous field presence, working closely
            with rural communities across three provinces to create sustainable impact.
          </p>
        </div>
    ...
    <section class="themed-section">
      <div class="container">
        <div class="section-header">
          ...
          <p>
            Our work spans environment, education, and livelihoods — each area with its own
            measurable outcomes and human stories.
          </p>
        </div>
    ...
    <section class="methodology-section">
      <div class="container">
        <div class="section-header">
          ...
          <h2>How We Count</h2>
          <p>
            Every number we publish is backed by a rigorous monitoring framework and independent
            verification.
          </p>
        </div>
