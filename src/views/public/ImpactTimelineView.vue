      ...
      <div class="hero-container">
        ...
        <div class="hero-text-col">
          ...
          <p class="hero-subtext">
            From a small pagoda in Svay Rieng to 293 villages across three provinces —
            the milestones that shaped Santi Sena.
          </p>
...
@keyframes ringFloat {
  ...
  50% { transform: translate(-4%, 4%) scale(1.04); opacity: 0.8; }
}
...
.timeline-card {
  ...
  transition: transform 0.3s ease, box-shadow 0.3s ease, opacity 0.6s ease, border-color 0.3s ease;
  overflow: hidden;
  cursor: pointer;
  opacity: 0;
...
@keyframes wavePulse {
  0%, 100% { transform: translateX(0) scale(1); color: #2d7a5a; }
  25% { transform: translateX(4px) scale(1.04); color: #1a6a4a; }
  50% { transform: translateX(-2px) scale(0.98); color: #2d7a5a; }
  75% { transform: translateX(3px) scale(1.02); color: #1a6a4a; }
}
...
.timeline-card:hover ~ .timeline-node .node-year {
  ...
  box-shadow: 0 14px 34px rgba(29, 138, 79, 0.20);
}
