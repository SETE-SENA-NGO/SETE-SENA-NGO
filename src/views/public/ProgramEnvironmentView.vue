...
const initiatives = [
  {
    ...
    img: imageUrls.programs.environment,
  },
  {
    ...
    img: imageUrls.programs.education,
  },
  {
  ...
  },
  {
    ...
    img: imageUrls.programs.livelihoodHero2,
  },
  {
    ...
    img: imageUrls.programs.environmentHero1,
  },
]
...
const impactStats = reactive<CounterStat[]>(
...
/* ─── Template refs ────────────────────────────── */
const cardRefs = reactive<Record<CardGroup, Element[]>>({ overview: [], initiatives: [], process: [] })
...
onMounted(() => {
  ...
  observe(impactSectionRef.value, () => {
    ...
    impactStatsRaw.forEach((_, i) => {
      ...
      if (stat) setTimeout(() => animateCounter(stat), i * 110)
    })
  })
